...
nodos["Aghios Nikolaos"] = NodosMetro("Aghios Nikolaos", 193, 331, 1)
...
nodos.get("Nea Ionia").adyacentes.append([nodos.get("Traklio"),1070])
...
nodos.get("Omonia").adyacentes.append([nodos.get("Metaouxrghio"),700])
